package Misc_2015.Autos_Einlesen;
...
public class Auto implements Comparable<Auto> {
    ...
    public String toString(){
       ...
       String ret = "<html>";
        ...
        ret += "<br>"+
                    "Misc_2015.MobileGUI.Auto:\t\t"+this.name+
                    "<br>Misc_2015.MobileGUI.Ort:\t\t"+this.ort+
                    "<br>Km:\t\t\t"+this.km+
                    "<br>Art:\t\t"+this.art+
                    "<br>Anbieter:\t"+this.anbieter+
                    "<br>EZ:\t\t\t"+this.ez+
                    "<br>HU:\t\t\t"+this.hu+
                    "<br>Misc_2015.MobileGUI.Leistung:\t"+this.leistung+
   ...
   /* public static final Comparator<Misc_2015.MobileGUI.Auto> SORT_PREIS = new Comparator<Misc_2015.MobileGUI.Auto>() { --> Strings, die Zahlen sind, müssen noch in INT geparsed werden
        @Override
        public int compare(Misc_2015.MobileGUI.Auto o1, Misc_2015.MobileGUI.Auto o2) {
            if(o1 == null && o2 == null) return 0;
            if(o1 == null) return 1;
            if(02 == null) return -1;
