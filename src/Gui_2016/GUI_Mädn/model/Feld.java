 ...
 * speziell einem {@link Gui_2016.GUI_Mädn.model.Haus} oder einer {@link Gui_2016.GUI_Mädn.model.Ziel}
 * zugeordnet werden. Feldern können {@link Gui_2016.GUI_Mädn.model.Farbe}n
 * zugewiesen sein, die bei der Darstellung leerer 
 * Felder berücksichtigt wird. Auf Feldern kann genau
 * eine {@link Gui_2016.GUI_Mädn.model.Figur} beliebiger Farbe stehen.
 * @author Nico Krebs und XIII.04
 * @see Gui_2016.GUI_Mädn.model.Umlauf
 * @see Gui_2016.GUI_Mädn.model.Farbe
 * @see Gui_2016.GUI_Mädn.model.Figur
 * @see Gui_2016.GUI_Mädn.model.Haus
 * @see Gui_2016.GUI_Mädn.model.Ziel
 */
public class Feld {
	/**
	 ...
	 * Zug ist (siehe 
	 * {@link Gui_2016.GUI_Mädn.model.Spiel#schalteFigurenFrei(Spieler)}).
	 */
	 ...
	 * Die Methode wird von der Klasse {@link Gui_2016.GUI_Mädn.model.Spiel}
